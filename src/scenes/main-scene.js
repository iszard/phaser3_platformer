...
export default class MainScene extends Phaser.Scene {
  preload() {
    this.load.tilemapTiledJSON("map", "src/assets/tilemaps/level.json");
    this.load.image(
      "kenney-tileset-64px-extruded",
      "src/assets/tilesets/kenney-tileset-64px-extruded.png"
    );

    this.load.image("wooden-plank", "src/assets/images/wooden-plank.png");
